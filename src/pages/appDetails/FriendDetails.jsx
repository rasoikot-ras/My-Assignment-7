                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-4">
                        <div className="bg-white p-10 rounded-xl border border-gray-100 shadow-sm text-center">
                            ...
                            <p className="text-[#64748B] text-[12px] font-bold  tracking-wider">Preferred: <span className="text-gray-600">{friend.email}</span></p>
                        </div>

                        <div className="space-y-2">
                            <button className="w-full py-4 bg-white border border-gray-100 rounded-lg flex items-center justify-center gap-3 font-medium text-gray-700 text-base tracking-widest shadow-sm hover:bg-gray-50">
                                <FaClock className="text-gray-400"/> Snooze 2 Weeks
                            </button>
                            <button className="w-full py-4 bg-white border border-gray-100 rounded-lg flex items-center justify-center gap-3 font-medium text-gray-700 text-base tracking-widest shadow-sm hover:bg-gray-50">
                                <FaBoxArchive className="text-gray-400"/> Archive
                            </button>
                            <button className="w-full py-4 bg-white border border-gray-100 rounded-lg flex items-center justify-center gap-3 font-medium text-[#FF4D4D] text-base tracking-widest shadow-sm hover:bg-red-50">
                                <FaTrash/> Delete
                            </button>
                        </div>
                    </div>
